...
public class ConsoleGame {
	...
	private Level level;
	private String moveSpaceString = "How many spaces would you like this vehicle to move? ";
	...
	public void playGame() {
		...
		while(!level.win()) {
			...
			if(!level.moveVehicle(getLocationFromUser(level.getRows(),level.getColumns()), getInteger(moveSpaceString))){
				System.err.print("That vehicle cannot be moved there, try again.");
			}
		}
		System.out.println(level);  //use this line to print out the current level with the header row information
		System.out.println("You win! Thanks for playing Traffic Jam!");
